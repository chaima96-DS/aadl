                    ...
                    <table id="dtBasicExample" class="table   table-sm table-bordered cellspacing="0" width="100%" style="border-collapse: collapse; border-radius: 5px; overflow: hidden;border:  black">
                        ...
                        <thead class="bg-primary text-white text-center">
                            <tr>
                                ...
                                <th class="col-1 th-sm text-center">Action
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href=""  class="btn" style="  padding: 10px; border-radius: 10px; box-shadow: 0 20px 15px rgba(0, 0, 0, .1);"><img src="./image/icons8-supprimer.svg" alt="#"></a>
                                </td>
